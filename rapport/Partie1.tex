...
Nous avons donc l'intégrité et l'authenticité du message, de la longueur de IV, de la longueur du message, et des données périphérique au message, mais pour terminer l'intégrité des données on va ajouter a ceci l'IV et la clef K. %pour être certain que personne n'a touché a notre vecteur d'initialisation ainsi que
