...
Nous avons pu dans un premier temps décrire le fonctionnement de \aes, puis nous l'avons comparé à d'autre algorithme répondant aux même caractéristiques: OCB et CCM. Nous avons remarqué à la fin de cette étude de comparaison que GCM n'était pas l'algorithme le plus rapide puisque sur plusieurs architectures différentes c'est OCB qui se distingue. Néanmoins OCB est un algorithme sous brevet au États-Unies qui est sensible à un certain nombre d'attaques.
